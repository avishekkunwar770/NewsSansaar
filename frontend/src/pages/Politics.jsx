...
const Politics = () => {
  ...
  useEffect(() => {
    // Fetching the politics news
    fetch("http://localhost:5000/api/news/category/politics")
      .then((res) => res.json())
      .then((result) => {
        setPoliticsNews(result.data || []);
        setLoading(false);
      })
      .catch((err) => {
  ...
  return (
    <div className="pt-24 px-6">
      ...
      <h1 className="text-4xl font-bold mt-4">Politics</h1>
      <p className="text-lg text-gray-500 mb-6">
        Latest news and updates from the politics category.
      </p>
            ...
            >
              ...
              <div className="p-4">
                <h2
                  ...
                  onClick={() => navigate(`/foreign?id=${news.id}`)} // Change to foreign
                >
                  {news.title}
                </h2>
